  ...
  IOCTL_SPECIAL(DRM_IOCTL_I915_GETPARAM, IOC_RW, do_ioctl_i915_getparam, MK_PTR(MK_STRUCT(STRUCT_drm_i915_getparam_t)))
...
//   IOCTL(DRM_IOCTL_I915_GEM_EXECBUFFER2, IOC_W, MK_PTR(MK_STRUCT(STRUCT_drm_i915_gem_execbuffer2)))
  ...
  IOCTL_SPECIAL(DRM_IOCTL_I915_GEM_EXECBUFFER2, IOC_W, do_ioctl_i915_gem_execbuffer2, MK_PTR(MK_STRUCT(STRUCT_drm_i915_gem_execbuffer2)))
...
//   IOCTL(DRM_IOCTL_I915_GEM_MMAP_GTT, IOC_RW, MK_PTR(MK_STRUCT(STRUCT_drm_i915_gem_mmap_gtt)))
  IOCTL_SPECIAL(DRM_IOCTL_I915_GEM_MMAP_GTT, IOC_RW, do_ioctl_i915_gem_mmap_gtt, MK_PTR(MK_STRUCT(STRUCT_drm_i915_gem_mmap_gtt)))
